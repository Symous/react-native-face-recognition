...
public class FaceRecognitionModule extends ReactContextBaseJavaModule {
    ...
    @ReactMethod
    public void configLivenessTypes(ReadableArray types, boolean random) {
        livenessList.clear();
        if (types.size() == 0) {
            ...
            for (int i = 0; i < types.size() ; i++) {
                int type = types.getInt(i);
                if (type == LivenessTypeEnum.Eye.ordinal()) livenessList.add(LivenessTypeEnum.Eye);
                else if (type == LivenessTypeEnum.Mouth.ordinal())
                    livenessList.add(LivenessTypeEnum.Mouth);
                else if (type == LivenessTypeEnum.HeadUp.ordinal())
                    livenessList.add(LivenessTypeEnum.HeadUp);
                else if (type == LivenessTypeEnum.HeadDown.ordinal())
                    livenessList.add(LivenessTypeEnum.HeadDown);
                else if (type == LivenessTypeEnum.HeadLeft.ordinal())
                    livenessList.add(LivenessTypeEnum.HeadLeft);
                else if (type == LivenessTypeEnum.HeadRight.ordinal())
                    livenessList.add(LivenessTypeEnum.HeadRight);
                else if (type == LivenessTypeEnum.HeadLeftOrRight.ordinal())
                    livenessList.add(LivenessTypeEnum.HeadLeftOrRight);
            }
        }
